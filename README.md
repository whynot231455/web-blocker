...
<p id="description">⛔ CTRL+BLCK ⛔- A lightweight Chrome extension designed to boost productivity by blocking distracting websites with seamless one-click implementation.</p>
